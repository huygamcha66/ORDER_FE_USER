...
import { Button, Col, ConfigProvider, Drawer, Flex, Input, Row, Space } from 'antd'
const { Search } = Input
      ...
      >
        <div className="wrapper_header">
          <Row justify="center">
            ...
            <Col xs={22} lg={20}>
              <Row style={{ display: 'flex', justifyItems: 'center' }} gutter={10}>
                <Col xs={3} sm={0}>
                  <Button type="primary" onClick={showDrawer}>
                    <FaBars />
                  </Button>
                  <Drawer title="Order Kiều Nghĩa" onClose={onClose} open={open}>
                    <Row>
                      <Col xs={24} sm={6} md={9} lg={9} xl={4}>
                        <Flex vertical>
                          <a href="tel:0931.943.439" className="tooltip" title="0931.943.439">
                            <CiPhone className="icon" />
                            <span>0931.943.439</span>
                          </a>
                          <a
                          ...
                          <Link to={'/register'} rel="noreferrer">
                            <FaRegUser /> <Space style={{ fontSize: '16px' }}>Đăng ký</Space>
                          </Link>
                          <Link to={'/login'} rel="noreferrer">
                            <IoIosLogIn /> <Space style={{ fontSize: '16px' }}>Đăng nhập</Space>
                          </Link>
                        </Flex>
                      </Col>
                    </Row>
