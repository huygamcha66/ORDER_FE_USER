...
const ExtraFooter = () => {
  return (
    <>
        ...
        <div className="container" style={{ padding: "0px 5px" }}>
          ...
          <div className="col3">
            ...
            <div className="likefb">
              <div
                className="fb-like-box fb_iframe_widget"
                data-href="https://www.facebook.com/orderhangquangchau24h/"
                data-width="340"
                data-height="333"
                ...
                fb-iframe-plugin-query="app_id=1869996503282359&amp;color_scheme=light&amp;container_width=340&amp;header=false&amp;height=333&amp;href=https%3A%2F%2Fwww.facebook.com%2Forderhangquangchau24h%2F&amp;locale=vi_VN&amp;sdk=joey&amp;show_border=false&amp;show_faces=true&amp;stream=false&amp;width=340"
              >
                <span
                  style={{
            ...
            <ul>
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  title="Trình duyệt Chrome"
                >
                  <img src={IC15} alt="Trình duyệt Chrome" />
                  Trình duyệt Chrome
                </a>
              </li>
              <li>
                ...
                >
                  <img src={IC16} alt="Trình duyệt Cốc Cốc" />
                  Trình duyệt Cốc Cốc
                </a>
              </li>
            </ul>
      ...
      <div className="copyright">Copyright by tatcadichvu.com © 2014</div>
