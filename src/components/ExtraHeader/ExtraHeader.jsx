...
const ExtraHeader = () => {
  ...
  return (
    <>
      <div className="top_header">{renderHeader()}</div>
              ...
              <div id="topsearch">
                <div className="frame">
                  ...
                  <div id="SkypeButton_Call_HN" className="skype_frame">
                    <p
                      id="SkypeButton_Call_HN_paraElement"
                      style={{ fontSize: "14px", color: "#444444" }}
                    >
                      <a href="skype:orderhangquangchau02?chat">
                        <img
                          src="http://my.orderhangquangchau.com/static/images/chatbutton_16px.png"
                          alt="Skype chat, instant message"
                          role="Button"
                          style={{
                            border: 0,
                            margin: "16px",
                  ...
                  <div id="SkypeButton_Call_HCM" className="skype_frame">
                    <p
                      ...
                      style={{ fontSize: "14px", color: "#444444" }}
                    >
                      <a href="skype:orderhangquangchau03?chat">
                        <img
                          src="http://my.orderhangquangchau.com/static/images/chatbutton_16px.png"
                          alt="Skype chat, instant message"
                          role="Button"
                ...
                <div className="hotline">
                  <div>
                    <span className="store">Kho hàng ĐN:</span>{" "}
                    <b style={{ color: "#4053b2" }}>0905.671.000</b>
                    <br />
                    <br />
                  </div>
                </div>
            ...
            >
              <ul className="nav navbar-nav">
                ...
                >
                  ...
                  />
                  <Link target="_blank" rel="noreferrer" to="/bang-gia">
                    Bảng giá
                  </Link>
                </li>
