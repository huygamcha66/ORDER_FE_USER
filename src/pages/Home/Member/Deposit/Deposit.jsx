      ...
      <div className="col-sm-9">
        <div className="content-page">
          <div className="titles">
            <h2 className="page-title">Quản lý ví điện tử</h2>
          </div>
                ...
                <div className="customer_credit_owe owe_6709" data-id="6709">
                  ...
                  <p>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      href="https://my.orderhangquangchau.com/member/reportowe"
                    >
                      Xem chi tiết
                    </a>
                  </p>
          ...
          <div className="form_deposit">
            ...
            <p className="note red">
              Để duyệt tiền nhanh và không cần gửi giao dịch. Vui lòng nhập nội dung chuyển tiền :{' '}
              <span className="green big">HQC6709CK</span> . Chỉ dành cho khách hàng sử dụng
              Internet - Banking
            </p>
            <div className="space10"></div>
            <form className="form-horizontal" method="POST">
              ...
              <div className="form-group" id="bank">
                <label for="bank" className="control-label col-sm-2">
                  Ngân hàng đã chuyển
                </label>
                <div className="col-sm-6">
              ...
              <div className="form-group" id="billpayment">
                <label htmlFor="billpayment" className="control-label col-sm-2">
                  Mã phiếu thu
                </label>

                <div className="col-sm-6">
                  <input
                    placeholder="Số bút toán sau khi bạn chuyển khoản"
                    className="inputAccount form-control"
                    value=""
                    type="text"
                    name="billpayment"
                    fdprocessedid="hn5x7k"
                  />
                </div>
              </div>
              <div className="form-group">
                <label htmlFor="comment" className="control-label col-sm-2">
                  Ghi chú
                </label>
                <div className="col-sm-6">
                  <textarea
          ...
          <div className="tab_container">
            <div className="tab_content">
              ...
              <p>
                <strong>
                  Tổng tiền đã duyệt : <span className="green">0</span>
                  <span className="small"> đ</span>
                </strong>{' '}
                -
                <strong>
                  Tổng tiền chờ duyệt : <span className="green">0</span>
                  <span className="small"> đ</span>
                </strong>
              </p>
              <div className="space10"></div>
              ...
              <div className="table-responsive">
                ...
                <p>
                  <strong>
                    Total: <span className="green">0</span> (Giao dịch)
                  </strong>
                </p>
              </div>
            </div>
