    ...
    <>
      <div class="col-sm-9">
        <div class="content-page">
          <div class="titles">
            <h2 class="page-title">Danh sách đơn hàng được giảm trừ</h2>
          </div>
          <div class="tab_container">
            <div class="tab_content">
              ...
              <p>
                <strong>
                  Đây là danh sách các lần giảm trừ trong đơn hàng, Số tiền giảm trừ sẽ được trừ
                  trực tiếp vào tổng giá trị đơn hàng
                </strong>
              </p>
              <div class="space10"></div>
              <p>
                <strong>
                  Tổng tiền đã giảm trừ : <span class="green">0</span>
              ...
              <div class="table-responsive">
                ...
                <p>
                  <strong>
                    Total: <span class="green">0</span> (Giao dịch)
                  </strong>
                </p>
              </div>
            </div>
