      ...
      <Col xs={24} lg={20}>
        <div className="col-inner">
          ...
          <div className="cate_cont">
            <h1>
              <strong>BẢNG GIÁ DỊCH VỤ &#8211; ORDER HÀNG QUẢNG CHÂU</strong>
            </h1>
            <p>
              <strong> (</strong>
              <strong>
          ...
          <div className="cate_cont">
            ...
            <ul>
              <li>
                1. Order Kiều Nghĩa sẽ kiểm tra hàng khi nhận được tại kho Trung
                Quốc theo số lượng và các thuộc tính cơ bản phân loại hàng hóa
                mà khách hàng đã thao tác chọn khi đưa vào giỏ hàng (đối với
                hàng thời trang thường là thuộc tính size, màu sắc nhưng loại
                trừ trường hợp màu sắc sản phẩm thực tế có thể đậm/nhạt hơn so
                với màu sắc sản phẩm đăng bán trên website)
              </li>
              <li>
                2. Order Kiều Nghĩa không cam kết sẽ kiểm tra chất liệu, thông
                số kỹ thuật, chất lượng sản phẩm, thương hiệu sản phẩm. Ví dụ
                với mặt hàng thời trang: bộ phận kiểm hàng không thể kiểm được
                từng đường may, mũi chỉ, hoặc chất lượng vải&#8230; vấn đề đó
                thuộc về nhà bán, khách hàng tìm kiếm và chọn lọc những nhà bán
                uy tín để nhập hàng. Tuy nhiên, OrdeOrder Kiều Nghĩarách nhiệm
                hỗ trợ khiếu nại yêu cầu shop đền bù nếu hàng không được đảm bảo
                chất lượng như khách mong muốn.
              </li>
            </ul>
          </div>
        </div>
