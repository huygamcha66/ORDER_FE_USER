        ...
        <div className="article-inner has-shadow box-shadow-1">
          <header className="entry-header">
            <div className="entry-header-text entry-header-text-top text-left">
              ...
              <h1 className="entry-title">
                Dịch vụ nạp tiền Alipay, thanh toán tiền Trung Quốc, chuyển tiền
                Trung
              </h1>
          ...
          <div className="entry-content single-page">
            ...
            <p className="rtejustify rtecenter">
              ...
              sinh hay những chủ shop có nhu cầu sang tận Trung Quốc nhập hàng.
              Để đổi tiền Việt sang tiền Trung Quốc, bạn thực hiện theo các bước
              như sau:
            </p>
            <p className="rtejustify rtecenter">
            ...
            <p className="rtejustify rtecenter">
              <strong>Bước 2:</strong> Bạn chuyển khoản vào số tài khoản của bên
              công ty dịch vụ đổi tiền
            </p>
            <p className="rtejustify rtecenter">
              <strong>Bước 3: </strong>Cung cấp tài khoản bên Trung Quốc cần
              nhận tiền qua tin nhắn, wechat, zalo, facebook,…… sau khi các nhân
              viên công ty đổi tiền nhận được tiền tại tài khoản Trung Quốc ngay
              lập tức sẽ chuyển khoản sang tài khoản quý khách yêu cầu.
            </p>
            <p>
              <span style={{ color: "#ed1c24" }}>
                <em>
                  *Lưu ý: Tỷ giá đổi tiền sẽ được cập nhật hằng ngày theo sát
                  nhất giá thị trường, quý khách có thể nhắn tin với Order hàng
                  Quảng Châu để nắm được tỷ giá tại thời điểm cần chuyển.
                </em>
              </span>
            </p>
            <p>&nbsp;</p>
