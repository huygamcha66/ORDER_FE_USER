          ...
          <div className="box box-chipo clearfix">
            <div className="list-order clearfix">
              <div className="table-responsive">
                <form
                  action="https://my.orderhangquangchau.com/ShipOrder/addOrderShipOnly"
                  method="POST"
                  id="myformID"
                >
                  <table
                  ...
                  >
                    <thead>
                      <tr className="header-cart-table">
                        ...
                        <td className="center" style={{ width: '16%' }}>
                      ...
                      <tr id="row_add_shiporder_item">
                        ...
                        <td>
                          <input
                            ...
                            fdprocessedid="o5v0kh"
                          />
                        </td>
                        <td>
                          <input
                            name="rec_name"
                            id="shiporder_rec_name"
                            value=""
                            placeholder="Tên người nhận"
                            className="form-control"
                            fdprocessedid="ri97w6"
                          />
                        </td>
                        <td>
                          <textarea
                        ...
                        <td>
                          <button
                            id="add_shiporder_item"
                            className="form-control btn-success"
                            style={{
                              backgroundColor: '#5cb85c !important',
                              borderColor: '#4cae4c !important'
                            }}
                            fdprocessedid="0hheyd"
                          >
                            Thêm
                          </button>
                        </td>
