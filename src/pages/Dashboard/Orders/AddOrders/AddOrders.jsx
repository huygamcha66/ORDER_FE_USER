      ...
      <div className="col-sm-12">
        <div className="cart-by-page">
          <div className="titles">
            <h2 className="page-title">Thêm đơn hàng</h2>
          </div>
          <div
            className="col-sm-12"
            style={{
            ...
            <div className="box box-chipo clearfix">
              <div className="list-order clearfix">
                <div className="table-responsive  size_medium">
                              ...
                              <div class="w2ui-msg-body w2ui-msg-no-buttons">
                                ...
                                >
                                  ...
                                  <form
                                    name="changesupport"
                                    action=""
                                    class="align-center ajaxForm Support"
                                    method="POST"
                                  >
                  ...
                  <table
                    className="table table-striped table-bordered table-hover table_cart"
                    id="shiporderTable"
                  >
                    <thead>
                        ...
                        <td>
                          ...
                          >
                            ...
                            <Modal
                              ...
                              onCancel={handleUploadImageCancel}
                              footer={null}
                            >
                              <form
                                action="https://my.orderhangquangchau.com/S3uploadfile/addImagesOrders"
                                method="POST"
